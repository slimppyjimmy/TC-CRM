    ...
    <el-dialog title="添加新客户" :visible.sync="outerVisible" width="80%" center>
      ...
      >
        ...
        <el-form-item label="获得客户时间：" class="baseitem">
          <el-date-picker
            v-model="customerform.pclientAddtime"
            type="date"
            placeholder="选择日期"
            format="yyyy-MM-dd"
        ...
        <el-form-item class="baseitem">
          <el-col :span="10">
            <el-form-item label="客户名称：" prop="customerform.pclientName">
              <el-input
                v-model="customerform.pclientName"
                placeholder="客户名称"
                style="width:60%"
                @click="personinfo"
              ></el-input>
        ...
        <el-form-item class="baseitem">
          ...
          <el-col :span="10">
            <el-form-item label="生日：">
              <el-date-picker v-model="customerform.pclientBirthday" type="date" placeholder="选择日期" format="yyyy-MM-dd"
...
export default {
  ...
  methods: {
    save() {
      ...
      api.sendData(this.customerform).then(resp => {
  ...
  data() {
    return {
      ...
      customerform: {
        ...
        // pclientAddressip: null
        // pclientAddtime: "2019-08-06"
        // pclientBirthday: null
        // pclientCityId: null
        // pclientCompanyName: "过酰胺"
        // pclientDesc: null
        // pclientEmail: "158"
        // pclientFromId: null
        ...
        // pclientJobId: null
        // pclientLevelId: null
        // pclientMaturityId: null

        // pclientPhone: 110
        // pclientProductId: null
        // pclientResp: null
        // pclientStatusId: null
        // pclientTel: null
        // pclientTypeId: null
      },
