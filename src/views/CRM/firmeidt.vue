        ...
        <el-form-item class="baseitem">
          ...
          <el-col :span="10">
            <el-form-item label="企业电话：">
              <el-input v-model="customerform.clientTel" style="width:60%"></el-input>
            </el-form-item>
          </el-col>
        </el-form-item>
        ...
        <el-form-item class="baseitem">
          <el-col :span="10">
            <el-form-item label="工作单位：" required>
              <el-input v-model="customerform.clientCompanyName" style="width:60%"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="4">&nbsp;</el-col>
          <el-col :span="10">
...
export default {
  ...
  methods: {
    ...
    save() {
      api.firmedit(this.customerform).then(resp =>{
