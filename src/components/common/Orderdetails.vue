<template>
  <div id="Orderdetails">
    <div @click="dialogVisible = true;stateDiaLog">{{data.s_order}}</div>
    <el-dialog
      title="订单详情"
...
<!--          </div>-->
      ...
      <table class="Orderdetails-table">
        ...
        <tr>
          ...
          <td style="width:35%"><span><img src="../../../static/images/usreicon_20.png" alt=""
            ...
            style="color: #5a87d6;">{{data.s_Inputperson}}</span></span></td>
          <td style="width:15%" class="right">负责人:</td>
          <td style="width:35%"><img src="../../../static/images/usreicon_20.png" alt=""
                                     style="height: 20px;width: 20px;border-radius: 50%;">&nbsp;<span
            style="color: #5a87d6;">{{data.s_personcharge}}</span></td>
        </tr>
        <tr class="el-tr">
          <td colspan="4" class="Orderdetails-table-titleTR">
            发货内容
        ...
        <tr>
          ...
          <td style="width:35%"><span class="complete-btn">{{data.s_state}}</span></td>
          <td style="width:15%" class="right">负责人:</td>
          <td style="width:35%">
            <img src="../../../static/images/usreicon_20.png" alt=""
                 style="height: 20px;width: 20px;border-radius: 50%;">&nbsp;
            <span style="color: #5a87d6;font-weight: 600;">{{data.s_personcharge}}</span>&nbsp;<span style="color: #5a87d6;">{{data.s_state}}</span>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td style="width:35%"><span style="color: red;">14点30分</span></td>
        ...
        <tr>
          ...
          <td style="width:35%" colspan="3"><span>{{data.s_theme}}</span></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td style="width:35%"><span>{{data.s_money}}</span></td>
    ...
    <el-button style="position: relative;right: 47%;" @click="dialogVisible = false">关 闭</el-button>
  </span>
    </el-dialog>
